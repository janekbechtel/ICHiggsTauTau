...
if "sm" in args.channel:
    dir = "output_17_4/tag_and_probe_sm_v17_4/"
elif "dm" in args.channel:
    dir = "output_17_4/tag_and_probe_dm_v17_4/"
elif "e" in args.channel:
    dir = "output_17_4/tag_and_probe_e_v17_4/"
else:
...
if args.fit:
    if "m" in args.channel:
        for label in parameters.keys():
            pass
            if "sm" in args.channel:
                filename = ["output_17_4/ZmmTP_Embedding.root", "output_17_4/ZmmTP_Data_sm.root", "output_17_4/ZmmTP_DY.root"]
            else:
                filename = ["output_17_4/ZmmTP_Embedding.root", "output_17_4/ZmmTP_Data.root", "output_17_4/ZmmTP_DY.root"]
        ...
        filename = ["output_17_4/ZeeTP_Embedding.root", "output_17_4/ZeeTP_Data.root", "output_17_4/ZeeTP_DYJetsToLL.root"]
        dir_ext = ["/embedding", "/data", "/DY"]
...
if args.plot:
    if "m" in args.channel:
        for label in mu_sliceing.keys():
            files = ["output_17_4/ZmmTP_Data_sm_Fits_" + label + ".root",
                    "output_17_4/ZmmTP_Embedding_Fits_" + label + ".root",
                    "output_17_4/ZmmTP_DY_Fits_" + label + ".root"
                    ]
            draw_options = [
                {
                    'Title':'Data'},
        ...
        for label in el_sliceing.keys():
            files = ["output_17_4/ZeeTP_Data_Fits_" + label + ".root",
                    "output_17_4/ZeeTP_Embedding_Fits_" + label + ".root",
                    "output_17_4/ZeeTP_DYJetsToLL_Fits_" + label + ".root"
                    ]
            draw_options = [
                {
                    'Title':'Data'},

...
bin_cfgs = [
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'muon_p && genZ_p && id_p && iso_p < 0.15',
        'probe': 'trg_p_IsoMu22',
        'binvar_x': 'pt_p',
    ...
    #    'var': 'm_ll(50,75,125)',
    #    'tag': 'muon_p && genZ_p && trg_t_IsoMu19Tau && id_p && iso_p < 0.15',
    ...
    #},
    {
        'name': 'Trg24_Iso_pt_eta_bins',
        'var': 'm_ll(50,75,125)',
        'tag': 'muon_p && genZ_p && abs(eta_t) < 2.1 && id_p && iso_p < 0.15',
        'probe': 'trg_p_IsoMu24',
        'binvar_x': 'pt_p',
    ...
    #    'var': 'm_ll(50,75,125)',
    #    'tag': 'muon_p && genZ_p && id_p && iso_p >= 0.15 && iso_p < 0.25',
    #    'probe': 'trg_p_IsoMu22',
    #    'binvar_x': 'pt_p',
    ...
    #    'var': 'm_ll(50,75,125)',
    #    'tag': 'muon_p && genZ_p && id_p && iso_p >= 0.25 && iso_p < 0.50',
    #    'probe': 'trg_p_IsoMu22',
    #    'binvar_x': 'pt_p',
    #    'bins_x': [20., 21., 22., 23., 24., 25., 30., 40., 50., 60., 80., 100., 1000.],
    #    'binvar_y': 'eta_p',
    ...
    #DESY like
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'muon_p && genZ_p && abs(eta_t) < 2.1',
        'probe': 'id_p',
        'binvar_x': 'pt_p',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'muon_p && genZ_p && abs(eta_t) < 2.1 && id_p',
        'probe': 'iso_p < 0.15',
        'binvar_x': 'pt_p',
        'bins_x': [10., 15., 20., 25., 30., 40., 50., 60., 70., 100., 1000.],
        'binvar_y': 'abs(eta_p)',
...
trees = {
    'DYJetsToLL': analysis.TTreeEvaluator('inclusive/ZmmTP', 'output/HTT2016Studies_v16_2_truth/ZmmTP/DYJetsToLLM50.root'),
...
for sample in trees:
    outfile = ROOT.TFile('v16_2_truthZ/ZmmTP_%s.root' % sample, 'RECREATE')

...
bin_cfgs = [
    ...
    },
    {
        ...
        'var': 'pt_p(99,10,1000)',
        'tag': 'muon_p && gen_p && wt < 1.0 && id_p && iso_p < 0.15',
        'probe': 'trg_p_IsoMu22',
        'binvar_x': 'pt_p',
    ...
    #    'var': 'pt_p(99,10,1000)',
    #    'tag': 'muon_p && gen_p && wt < 1.0 && trg_t_IsoMu19Tau && id_p && iso_p < 0.15',
    ...
    #    'var': 'pt_p(99,10,1000)',
    #    'tag': 'muon_p && gen_p && wt < 1.0 && id_p && iso_p >= 0.15 && iso_p < 0.25',
    #    'probe': 'trg_p_IsoMu22',
    #    'binvar_x': 'pt_p',
    ...
    #    'var': 'pt_p(99,10,1000)',
    #    'tag': 'muon_p && gen_p && wt < 1.0 && id_p && iso_p >= 0.25 && iso_p < 0.50',
    #    'probe': 'trg_p_IsoMu22',
    #    'binvar_x': 'pt_p',
    #    'bins_x': [20., 21., 22., 23., 24., 25., 30., 40., 50., 60., 80., 100., 1000.],
    #    'binvar_y': 'eta_p',

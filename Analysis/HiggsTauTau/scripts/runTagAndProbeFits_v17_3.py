...
if "sm" in args.channel:
    dir = "output/tag_and_probe_sm_v18_1/"
elif "dm" in args.channel:
    dir = "output/tag_and_probe_dm_v18_1/"
elif "e" in args.channel:
    dir = "output_17_3/tag_and_probe_e_v17_3/"
else:
...
if args.fit:
    if "m" in args.channel:
        ...
        filename = ["output_17_3/ZeeTP_Embedding.root", "output_17_3/ZeeTP_Data.root", "output_17_3/ZeeTP_DYJetsToLL.root"]
        dir_ext = ["/embedding", "/data", "/DY"]
...
if args.plot:
    if "m" in args.channel:
        ...
        for label in el_sliceing.keys():
            files = ["output_17_3/ZeeTP_Data_Fits_" + label + ".root",
                    "output_17_3/ZeeTP_Embedding_Fits_" + label + ".root",
                    "output_17_3/ZeeTP_DYJetsToLL_Fits_" + label + ".root"
                    ]
            draw_options = [
                {
                    'Title':'Data'},

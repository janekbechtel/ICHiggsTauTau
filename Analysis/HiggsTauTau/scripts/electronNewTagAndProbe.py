...
bin_cfgs = [
    ...
    #DESY like setup (using 27trigger and pt>28)
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele27eta2p1WPTight && pt_t > 28',
        'probe': 'id_p',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 25., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele27eta2p1WPTight && pt_t > 28 && id_p',
        'probe': 'iso_p < 0.10',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 25., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele27eta2p1WPTight && pt_t > 28 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    #with tag trigger object pt conditions
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 26 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 30 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 34 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 37 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 40 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 43 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 46 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t_25eta2p1TightL1 > 50 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    #using tag reco pt
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 26 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 30 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 34 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 37 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 40 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 43 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 46 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
    ...
    },
    {
        ...
        'var': 'm_ll(50,75,125)',
        'tag': 'trg_t_Ele25eta2p1WPTight && pt_t > 50 && id_p && iso_p < 0.10',
        'probe': 'trg_p_Ele25eta2p1WPTight',
        'binvar_x': 'pt_p',
        'bins_x': [10., 20., 22., 24., 26., 28., 30., 40., 50., 100., 200., 1000.],
        'binvar_y': 'abs(sc_eta_p)',
...
trees = {
    'DYJetsToLL': analysis.TTreeEvaluator('inclusive/ZeeTP', 'output/HTT2016Studies_v16_2/ZeeTP/DYJetsToLLM50.root'),
...
for sample in trees:
    outfile = ROOT.TFile('v16_2/ZeeTP_%s.root' % sample, 'RECREATE')
